...
** About Me
   I am a graduating Mathematics Ph.D. from the University of
   Virginia. I studied homotopy theory under the direction of
   [[http://pi.math.virginia.edu/Faculty/Kuhn/][Professor Nicholas Kuhn]]. In particular, my research concerned the
   structure of the equivariant stable homotopy Balmer spectrum and
   its applications to non-equivariant settings. My dissertation is
   titled [[https://doi.org/10.18130/3h64-wv15][Applications of Chromatic Fixed Point Theory.]]
...
*** Directed Reading Program
    Starting in Fall 2018 I have worked closely with [[http://www.people.virginia.edu/~sm4cw/Welcome.html][Professor. Sara Maloni]]

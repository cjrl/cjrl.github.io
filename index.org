...
** About Me
   ...
   I am a Data Science Fellow working for the [[https://www.pandemicoversight.gov/][Pandemic Response
   Accountability Committee (PRAC)]]. 
   
   Before becoming a Data Scientist. I graduated with Mathematics
   Ph.D. from the University of Virginia in Spring 2021. There, I
   studied homotopy theory under the direction of [[https://uva.theopenscholar.com/nick-kuhn][Professor Nicholas
   Kuhn]]. In particular, my research concerned the structure of the
   equivariant stable homotopy Balmer spectrum and its applications to
   non-equivariant settings. My dissertation is titled [[https://doi.org/10.18130/3h64-wv15][Applications of
